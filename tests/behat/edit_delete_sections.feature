@format @format_collapsibleweeks
Feature: Sections can be edited and deleted in collapsibleweeks format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | collapsibleweeks  | 0             | 5           | 957139200 |
  ...
  Scenario: View the default name of the general section in collapsibleweeks format
    When I edit the section "0"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "General"

  Scenario: Edit the default name of the general section in collapsibleweeks format
    When I edit the section "0" and I fill the form with:
      | Custom | 1                      |
      | New value for Section name      | This is the general section |
    Then I should see "This is the general section" in the "li#section-0" "css_element"

  Scenario: View the default name of the second section in collapsibleweeks format
  ...
  Scenario: Edit section default name in collapsibleweeks format
  ...
  Scenario: Edit section summary in collapsibleweeks format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "li#section-2" "css_element"
  ...
  Scenario: Deleting the last section in collapsibleweeks format
  ...
  Scenario: Deleting the middle section in collapsibleweeks format
    Given I should see "29 May - 4 June" in the "li#section-5" "css_element"
