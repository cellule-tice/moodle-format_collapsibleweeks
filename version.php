...
$plugin->version   = 2022061001;        // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = '3.11.1'; // Align version number with most recent moodle compatible version.
